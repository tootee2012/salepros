...
export default function BillAddressPage() {
  const [open, setOpen] = useState(false);
  const [addresses, setAddresses] = useState<BillAddress[]>([]);
  ...
  const handleEdit = (addr: BillAddress) => {
      ...
      >
        <DialogTitle sx={{ 
          ...
          <Typography component="div" fontWeight="bold" fontSize="1rem">
            {editingId ? 'แก้ไขที่อยู่วางบิล' : 'เพิ่มที่อยู่วางบิล'}
          </Typography>
